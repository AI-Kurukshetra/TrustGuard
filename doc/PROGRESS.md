...
[2026-03-14 17:03] codex — Added active merchant/company name rendering under the sidebar logo, wired through `PageShell` into both desktop sidebar and mobile drawer navigation.
