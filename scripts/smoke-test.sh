...
{"user_id":"${USER_ID}","browser":"Chrome","os":"macOS","screen_resolution":"1728x1117","ip_address":"34.219.28.17","hardware_signature":"sig_smoke_test"}
JSON
)"

request "POST" "/api/geographical-locations" '{"country_code":"US","region":"CA","city":"San Francisco","timezone":"America/Los_Angeles","risk_level":"low"}'
...
request "POST" "/api/fraud-patterns" '{"pattern_name":"Rapid Card Testing Cluster","category":"payment_fraud","severity":"high","detection_type":"rule","confidence":82.5}'
